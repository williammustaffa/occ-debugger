...
### Usage
Download latest release `occ-debugger-[version].zip` file, extract it. Access `chrome://extensions`, enable **developer mode** and load the extracted content though the `Load unpacked` button.
